...
/**
 * Created by Owen on 2023/6/2
 */
class SquareViewModel:BaseViewModel() {

    var squareLiveData=MutableLiveData<Flow<PagingData<Article>>>()

    fun getSquareList(){
        squareLiveData.value=HttpRepository.getSquareData().cachedIn(viewModelScope)
    }

...
object HttpRepository:BaseRepository() {
    ...
    /** 体系 */
     fun getStructureArticles(param: Any)=pager { page ->
        when (param) {
    ...
    /** 搜索公众号*/
    fun searchArticleWithKey(publicId: Int, key: String)=pager{ page ->
    ...
    /** 看妹纸*/
//     fun getWelfareData(key: String)= Pager(
